    ...
    >
      ...
      <div className="mt-6 flex flex-col gap-4 sm:flex-row sm:items-center">
        <button
          ...
          className="inline-flex items-center justify-center rounded-lg bg-accent-dark px-6 py-3 text-sm font-medium text-white shadow-sm transition-colors hover:bg-accent-deep focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-dark focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-70"
        >
